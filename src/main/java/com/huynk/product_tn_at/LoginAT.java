...
public class LoginAT {
    public static final String baseUrl = "http://localhost:9004/login";
    ...
    public void click_register() {
        ...
        // the expect value
        String expectedLinkLoginFoward = "http://localhost:9004/registration";
    ...
    public void click_login_empty_user_name() {
        ...
        // the expect value
        String expectedLinkLoginFoward = "http://localhost:9004/login";
...
/*    @Test
    ...
    public void click_login_admin_success() {
        ...
        // the expect value
        String expectedLinkLoginFoward = "http://localhost:9004/admin";
    ...
    public void click_login_user_success() {
        ...
        // the expect value
        String expectedLinkLoginFoward = "http://localhost:9004/index_";
